        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="{{ route('admin.product.store') }}" id="form" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Product Code <span class="text-red">*</span></label>
                    <div class="col-sm-2">
                      <input type="text" class="form-control" id="product_code" name="product_code" placeholder="Product Code" maxlength="10" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Product Name <span class="text-red">*</span></label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Product Name" maxlength="20" required>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                      <input type="number" class="form-control" id="stock_min" name="stock_min" placeholder="Stock Min." required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Price Purchase <span class="text-red">*</span></label>
                    <div class="col-sm-4">
                      <input type="number" class="form-control" id="price_purchase" name="price_purchase" placeholder="Price Purchase" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Price Sale <span class="text-red">*</span></label>
                    <div class="col-sm-4">
                      <input type="number" class="form-control" id="price_sale" name="price_sale" placeholder="Price Sale" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Price Reseller <span class="text-red">*</span></label>
                    <div class="col-sm-4">
                      <input type="number" class="form-control" id="price_reseller" name="price_reseller" placeholder="Price Reseller" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    *Size 450 x 600 pixel</label>
                    ...
                    <div class="col-sm-4">
                        <img id="img_viewer" src="#" alt="your image" height="600px" width="450px" style="display:none" />
                    </div>
                  </div>
